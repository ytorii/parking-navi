...
export default function ParkingMap({ query, label }: ParkingMapProps) {
  ...
  return (
    <section className="rounded-lg border border-slate-700 bg-slate-800 overflow-hidden shadow-sm">
      <div className="flex items-center justify-between px-4 py-3 border-b border-slate-700">
        <SectionHeader className="mb-0">
          <svg viewBox="0 0 20 20" className="h-3.5 w-3.5 fill-current inline mr-2" aria-hidden="true">
